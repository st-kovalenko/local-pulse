                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <form @submit.prevent="submitForm">
                        ...
                        <div class="flex items-center justify-end px-4 py-3 bg-gray-50 text-right sm:px-6 shadow sm:rounded-bl-md sm:rounded-br-md">
                            <Link :href="route('shops.news.index', shop)" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-red-500 bg-red-100 rounded-lg hover:bg-red-200 focus:ring-4 focus:outline-none focus:ring-red-500 mr-3">Cancel</Link>
...
export default {
    ...
    data() {
        return {
            form: useForm('put', route('shops.news.update', {shop: this.shop, news: this.news.id}), {
